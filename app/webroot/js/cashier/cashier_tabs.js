...
var pay = "<div class='pay_by_point'>"
...
var tabContent = "<div class='row' id='content-tabs'>" + content_left + content_right + "</div>" + pay;


var tabTemplate = "<li><a href='#{replace1}' class='tab_title'>#{replace2}</a> <i class='fas fa-times ui-icon-close-x' role='presentation' aria-hidden='true'></i></li>";
var tabCounter = 2;
...
function addTab(){
    ...
    // var TAB_index = $('li.ui-tabs-tab').last().index();
    // $(this).closest("li").click();
